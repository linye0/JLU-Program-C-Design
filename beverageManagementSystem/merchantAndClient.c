...
#define fileClientBuyLog "D:\\C-Project\\JLU-Program-C-Design\\data\\clientBuyLog.txt"
#define fileClientAccountLog "D:\\C-Project\\JLU-Program-C-Design\\data\\clientAccountLog.txt"
...
//同上 改成了float 所以main里面传参类型也要改成float。
