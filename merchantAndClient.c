...
{
    FILE *fp;
    char file0[]="C:\\Users\\86188\\Desktop\\buy.txt";
    fp = fopen(file0,"w");
   fprintf(fp,"%10s%11s%10s%11s%10s%10s%9s\n","账号","用户名","货物品牌","货物名称","货物价格","购买数量","时间");
    fclose(fp);
    char file1[]="C:\\Users\\86188\\Desktop\\tes.txt";
    fp = fopen(file1,"w");
...
void recordClientBuy(clientNode client, pBeverageList list, int number){
    FILE *fp;
    char file[]="C:\\Users\\86188\\Desktop\\buy.txt";
    fp = fopen(file,"at+");
...
void recordClientAccount(clientNode client,const char behavior[]){
    FILE *fp;
    char file[]="C:\\Users\\86188\\Desktop\\tes.txt";
    fp = fopen(file,"at+");
